...
export const Route = createFileRoute("/services/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          { title: `${loaderData.service.title} — NyayaOS` },
          { name: "description", content: loaderData.service.description },
          { property: "og:title", content: `${loaderData.service.title} — NyayaOS` },
          { property: "og:description", content: loaderData.service.description },
        ]
      : [{ title: "Service — NyayaOS" }],
  }),
  notFoundComponent: () => (
    ...
    <SoundProvider>
      ...
      <main className="pt-32 pb-24">
        <div className="mx-auto max-w-7xl px-6">
          ...
          {/* Related services */}
          <section className="mt-20">
            <h2 className="font-display text-2xl font-bold">More from NyayaOS</h2>
